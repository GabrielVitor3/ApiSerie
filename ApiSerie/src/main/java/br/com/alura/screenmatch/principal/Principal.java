...
public class Principal {
    ...
    public void exibeMenu() {
        ...
        while (opcao != 0) {
            var menu = """
                    ...
                    5 - Buscar sério pelo ator  
                    6 - Top 5 séries do banco de dados 
                    7 - Buscar séries por categoria 
                    8 - Filtrar séries
                    9 - Buscar episódio
                    10- Top 5 episódios 
                    11- Escolher a episódio por ano
                    0 - Sair                                 
                    """;
    ...
    private void buscarSeriePorTitulo() {
        ...
        if (serieBusca.isPresent()) {
            ...
            System.out.println("Série não encontrada na base de dados");
        }
    }

    private void buscarSeriePorAtor() {
        System.out.println("Qual é o nome do ator para a busca: ");
        ...
        serieEncontrada.forEach(s -> System.out.println(s.getTitulo() + "\nAvaliação: " + s.getAvaliacao()));
    }
    ...
    private void buscarSeriePorCategoria() {
        System.out.println("Qual categoria/gênero você quer? ");
    ...
    private void buscarEpisodioPorTrecho() {
        System.out.println("Qual é o nome do episodio para a busca: ");
